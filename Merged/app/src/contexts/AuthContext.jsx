...
export const AuthContextProvider = ({ children }) => {
  ...
  const fetchUserInterests = (userId, token) => {
    fetch("https://w20012045.nuwebspace.co.uk/kv6002/merged/api/interests", {
      method: 'GET',
      headers: new Headers({
      ...
      .then(data => {
        ...
        const interestsString = interestIDs.map((id) => {
          switch (id) {
            ...
            case 6:
              return "Future of work and education";
            case 7:
  ...
  const fetchUserData = (userId, token) => {
    fetch("https://w20012045.nuwebspace.co.uk/kv6002/merged/api/userdata", {
      method: 'GET',
      headers: new Headers({
        "Authorization": "Bearer " + token
      }),
